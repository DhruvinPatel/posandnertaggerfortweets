...
outputFeature =  open ('neroutputfeaturestest',"wb")

#brownfile = open ('brownclusterdata','r')
#brownlines = brownfile.readlines()
#brownfile.close()

#dic = {}
#for i in range(0,len(brownlines)):
#	line = brownlines[i].split()
	#print line
#	dic[line[1]] = int(line	[0],2)
